...
const BrandTable = () => {
  ...
  const { getBrands, changeStatusBrand } = useBrand();
  const { data: response, isLoading, error } = getBrands(page, limit);
  ...
  const handleEditClick = (brand: any) => {
    setBrandToEdit({ id: brand.id, name: brand.name });
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-3">
                        ...
                        {brand.isActive ? (
                          <Button
                            onClick={() =>
                              changeStatusBrand(brand.id, "Inactive")
                            }
                          ...
                          <Button
                            onClick={() =>
                              changeStatusBrand(brand.id, "Active")
                            }
